...
public class LibroModificado {
   ...
   private double precio; 
    ...
    public LibroModificado(  String unTitulo,  String unaEditorial, 
    ...
    public LibroModificado(  String unTitulo,  String unaEditorial, Autor unPrimerAutor, String unISBN){
         titulo = unTitulo;
         editorial = unaEditorial; 
         añoEdicion= 2015;
         primerAutor = unPrimerAutor;
